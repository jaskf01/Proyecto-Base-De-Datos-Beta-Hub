...
## sp_ActualizarMedidasDispersion
Este procedimiento actualiza las medidas de dispersión (varianza y desviación estándar) para las variables de análisis.
